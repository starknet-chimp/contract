...
export async function getAccount(): Promise<Account> {
	...
	const myAccount = await starknet.getAccountFromAddress(process.env.STARKNET_ADDRESS, process.env.STARKNET_PKEY, process.env.STARKNET_ACCOUNT_TYPE as AccountImplementationType);
